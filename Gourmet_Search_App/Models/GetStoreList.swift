...
struct GetStoreList {
    ...
    func getStoreList(keyword: String?, lat: Double, lng: Double, rangeCode: String, genres: [String?], budget: String?, start: Int) async -> Result<StoreListResponse, APIClientError> {
